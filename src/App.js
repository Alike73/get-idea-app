...
import WhatToDoApp from "./WhatToDoApp";
...
function App() {
  ...
  const svg = document.querySelector(".anim-explode");
  ...
  const fetchActivity = async () => {
    ...
    setMyActivity(dataActivity.activity)
  }
  ...
  return (
    <div>
      <RandomImage />
      <Title />
      <WhatToDoApp myActivity = {myActivity} />
      <Button trigger = {fetchActivity} mouseOverBtn = {mouseOverBtn} />
      <BottomImg />
      <SideImg />
      <Footer />
    </div>
